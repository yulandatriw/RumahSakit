					...
					<div id="namadokter">
						<table class="table2">
							...
							<tbody>
								...
								$result = mysqli_query($mysqli, "SELECT * FROM tabel_pembayaran WHERE namapasien like '%".$cari."%'");
									}
									else{
										$result = mysqli_query($mysqli, "SELECT * FROM tabel_pembayaran
										ORDER BY noregis ASC"); 
										} 
