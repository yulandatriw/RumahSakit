...
<head>
    <title>Pembayaran Edit - UAS </title>
...
<body>
    <header>
        <?php
        function headeer() {
            echo "Pembayaran Rumah Sakit Harapan";
        }
        headeer();
        ?>
    </header>
                                ...
                                <form class="col-12" action="Pembayaran_Edit2.php" method="post" name="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="submit-btn" type="submit" name="submitpembayaran" value="SIMPAN" />
                                </form>
                            </div>
