                ...
                <td>
                    <div id="namadokter">
                        <table class="table2">
                            ...
                            $result = mysqli_query($mysqli, "SELECT * FROM tabel_dokter WHERE
                            id = '$id'");
                            ...
                            ?>
                                <form class="col-12" action="Dokter_Edit1.php" method="post" name="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="namadokter" value="<?php echo $namadokter;?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="jadwal" value="<?php echo $jadwal;?>"
                                                    placeholder="--masukan jadwal disini--">
                                            </div>
                                            

                                            <input id="submit-btn" type="submit" name="update1" value="Simpan" />
                                </form>
                            </div>
